...
namespace Sudoku.DL
{
    public class Grid
    {
        ...
        public Grid(IImmutableList<string> rowStrings) //char sur une ligne
        {
        ...
        public Grid(ImmutableList<int> immutableLists)
        {
        }
    ...
    {
        public abstract void RegisterProvider(System.Text.EncodingProvider provider);
